...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_GetMeal_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/GetMeal.js */ \"./src/modules/GetMeal.js\");\n/* harmony import */ var _modules_generatePopupMarkup_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/generatePopupMarkup.js */ \"./src/modules/generatePopupMarkup.js\");\n/* harmony import */ var _modules_commentsHandler_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/commentsHandler.js */ \"./src/modules/commentsHandler.js\");\n/* harmony import */ var _modules_likesHandler_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/likesHandler.js */ \"./src/modules/likesHandler.js\");\n\r\n\r\n\r\n\r\n\r\n\r\nconst popupHook = document.querySelector(\".popup-hook\");\r\nconst itemContainer = document.querySelector(\".cards\");\r\n\r\n(async () => {\r\n  const meals = await (0,_modules_GetMeal_js__WEBPACK_IMPORTED_MODULE_1__.getData)();\r\n  const likes = await (0,_modules_likesHandler_js__WEBPACK_IMPORTED_MODULE_4__.getLikes)();\r\n  (0,_modules_GetMeal_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])({ meals, likes });\r\n})();\r\n\r\n// Displaying popup\r\nitemContainer.addEventListener(\"click\", async (e) => {\r\n  const clickedBtn = e.target.closest(\".card-btn\");\r\n\r\n  if (!clickedBtn) return;\r\n  const idMeal = JSON.parse(e.target.dataset.idMeal);\r\n\r\n  // Fetching comments\r\n  const commentsData = await (0,_modules_commentsHandler_js__WEBPACK_IMPORTED_MODULE_3__.getComments)(idMeal);\r\n  console.log(\"COMMENTSSSS...\", commentsData);\r\n\r\n  const { meals } = await (0,_modules_GetMeal_js__WEBPACK_IMPORTED_MODULE_1__.getSingeMeal)(idMeal);\r\n\r\n  const detailedCardData = meals[0];\r\n\r\n  const markup = (0,_modules_generatePopupMarkup_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])({ detailedCardData, commentsData });\r\n  popupHook.innerHTML = markup;\r\n\r\n  // Handle comment submit\r\n  const form = document.querySelector(\".comments-form\");\r\n\r\n  form.addEventListener(\"submit\", (e) => {\r\n    e.preventDefault();\r\n\r\n    const itemId = e.target.querySelector(\".submit-comment-btn\");\r\n\r\n    if (!itemId) return;\r\n\r\n    const item_id = itemId?.dataset?.idMeal;\r\n    const username = e.target.name.value;\r\n    const comment = e.target.comment.value;\r\n\r\n    if (!username || !comment) return;\r\n\r\n    (0,_modules_commentsHandler_js__WEBPACK_IMPORTED_MODULE_3__.postComment)({ item_id, username, comment });\r\n  });\r\n});\r\n\r\n// Close popup\r\npopupHook.addEventListener(\"click\", (e) => {\r\n  const closeBtn = e.target.closest(\".close-popup-btn\");\r\n  if (!closeBtn) return;\r\n  popupHook.innerHTML = \"\";\r\n});\r\n\r\npopupHook.addEventListener(\"click\", (e) => {\r\n  const closeBtn = e.target.closest(\".form-close-popup-btn\");\r\n  if (!closeBtn) return;\r\n  popupHook.innerHTML = \"\";\r\n});\r\n\r\n// Likes\r\nitemContainer.addEventListener(\"click\", (e) => {\r\n  const likeIcon = e.target.closest(\".item-icon\");\r\n  if (!likeIcon) return;\r\n\r\n  const { id } = likeIcon.dataset;\r\n\r\n  (0,_modules_likesHandler_js__WEBPACK_IMPORTED_MODULE_4__.postLike)({ item_id: id });\r\n});\r\n\n\n//# sourceURL=webpack://webpack-config/./src/index.js?");
