...
/***/ "./src/modules/updateLikeLocalHandler.js":
/*!***********************************************!*\
  !*** ./src/modules/updateLikeLocalHandler.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__),\n/* harmony export */   \"isAlreadyLiked\": () => (/* binding */ isAlreadyLiked),\n/* harmony export */   \"likeStatusAlreadyStored\": () => (/* binding */ likeStatusAlreadyStored)\n/* harmony export */ });\nconst updateLikeLocalHandler = (itemId) => {\r\n  const storedLikes = JSON.parse(localStorage.getItem(\"likes\")) || {};\r\n  //   { itemId: \"status\"} // \"like\"|\"unlike\"\r\n  const statusAvailable = storedLikes[itemId];\r\n  if (statusAvailable) {\r\n    if (statusAvailable === \"like\") {\r\n      storedLikes[itemId] = \"unlike\";\r\n    } else {\r\n      storedLikes[itemId] = \"like\";\r\n    }\r\n  } else {\r\n    storedLikes[itemId] = \"like\";\r\n  }\r\n\r\n  //   Update local storage\r\n  localStorage.setItem(\"likes\", JSON.stringify({ ...storedLikes }));\r\n};\r\n\r\nconst isAlreadyLiked = (itemId) => {\r\n  const likesObj = JSON.parse(localStorage.getItem(\"likes\")) || {};\r\n  const foundStatus = likesObj[itemId];\r\n  if (foundStatus && foundStatus === \"like\") return true;\r\n  return false;\r\n};\r\n\r\nconst likeStatusAlreadyStored = (itemId) => {\r\n  const likesObj = JSON.parse(localStorage.getItem(\"likes\")) || {};\r\n  const foundStatus = likesObj[itemId];\r\n  if (foundStatus) return true;\r\n  return false;\r\n};\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (updateLikeLocalHandler);\r\n\n\n//# sourceURL=webpack://webpack-config/./src/modules/updateLikeLocalHandler.js?");
